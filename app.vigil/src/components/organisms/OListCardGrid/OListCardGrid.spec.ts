...
import OListCardGrid from './OListCardGrid.vue';

type Slots = ComponentMountingOptions<typeof OListCardGrid>['slots'];
...
function mount(props: Record<string, unknown> = {}, slots: Slots = {}) {
  return mountWithPlugins(OListCardGrid, {
...
describe('OListCardGrid', () => {
  ...
  it('renders without an amount config', () => {
    const wrapper = mountWithPlugins(OListCardGrid, {
  ...
  it('renders the custom #actions slot per card', () => {
