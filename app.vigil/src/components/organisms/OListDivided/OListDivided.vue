...
<template>
  <div class="border-line bg-canvas overflow-hidden rounded-xl border">
    <div
      v-if="!items.length"
    ...
    >
      <div class="flex min-w-0 items-center gap-3">
        ...
        <span class="text-heading truncate text-sm font-medium">{{ fieldValue(item, title.valueKey) }}</span>
      </div>
