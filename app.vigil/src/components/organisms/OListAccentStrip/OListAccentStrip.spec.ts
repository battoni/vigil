...
import OListAccentStrip from './OListAccentStrip.vue';

type Slots = ComponentMountingOptions<typeof OListAccentStrip>['slots'];
...
function mount(props: Record<string, unknown> = {}, slots: Slots = {}) {
  return mountWithPlugins(OListAccentStrip, {
...
describe('OListAccentStrip', () => {
  ...
  it('renders without an amount config', () => {
    const wrapper = mountWithPlugins(OListAccentStrip, {
