---
title: Import ordering and module alias conventions for app.vigil (Vue 3 / TS)
outline: deep
---

::: info Generated page
This page is generated from `.claude/rules/celer-02-vue-imports.md` — **edit the source rule, not this page.** Activates for: `app.vigil/**/*.vue`, `app.vigil/**/*.ts`.
:::
