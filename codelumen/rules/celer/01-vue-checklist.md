---
title: MANDATORY checklist – run before/after every Vue/TS edit in app.vigil
outline: deep
---

::: info Generated page
This page is generated from `.claude/rules/celer-01-vue-checklist.md` — **edit the source rule, not this page.** Activates for: `app.vigil/**/*.vue`, `app.vigil/**/*.ts`.
:::
