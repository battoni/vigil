---
title: Design system rules – typography, spacing, radius, component patterns for app.vigil
outline: deep
---

::: info Generated page
This page is generated from `.claude/rules/celer-06-design-system.md` — **edit the source rule, not this page.** Activates for: `app.vigil/**/*.vue`, `app.vigil/**/*.ts`.
:::
