---
title: /generateApiRules
outline: deep
---

::: info Generated page
This page is generated from `.claude/commands/generateApiRules.md` — run it with `/generateApiRules`. **Edit the source command, not this page.**
:::
